...
public class ClientController extends Controller {
    ...
    void addReservation(ActionEvent event) {     
        ...
        String client = Launch.getFac().searchClient(clientdata);
         System.out.println(client);
        String model = txtModel.getText();
        String [] yachtdata = {"0","123", model};
        String yacht = Launch.getFac().searchYacht(yachtdata);
        ...
        Launch.getFac().addReservation(clientdata,yachtdata,datesOfReservation);
    ...
    void showYachts(ActionEvent event) {
       ...
       showItems(Launch.getFac().getYachtsData(), event);
